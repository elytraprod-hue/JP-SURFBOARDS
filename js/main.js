// Novo Formato Base de Dados (Padronização e Dims Default)
const productsLocalDB = [
    { 
        ...
        homeImage: './assets/images/black-buffalo-home.jpg', 
        modelImage: './assets/images/black-buffalo-model.jpg',
    ...
    { 
        ...
        homeImage: './assets/images/phantom-shark-home.jpg', 
        modelImage: './assets/images/phantom-shark-model.jpg',
    ...
    { 
        ...
        homeImage: './assets/images/white-tiger-home.jpg', 
        modelImage: './assets/images/white-tiger-model.jpg',
    ...
    { 
        ...
        homeImage: './assets/images/silver-bullet-home.jpg', 
        modelImage: './assets/images/silver-bullet-model.jpg',
    ...
    return `
        <div class="group cursor-pointer flex flex-col h-full bg-white border border-zinc-100 shadow-sm hover:shadow-2xl transition-all duration-300" onclick="window.location.href='modelo-detalhe.html?model=${p.id}'">
            <div class="p-6 flex-grow">
                <div class="w-full aspect-[4/5] overflow-hidden bg-zinc-50 mb-6 relative">
                    <img 
                        src="${p.homeImage}" 
                        loading="lazy"
                        alt="Prancha ${p.name}" 
                        class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-[1.5s] grayscale hover:grayscale-0" 
